...
class SaveButton extends Component {
	...
	async handleSubmit() {
		...
		const { step1Errors, step2Errors, step3Errors, photosCount } = this.props;
		...
		} else if (step === 2 && isEmpty(step2Errors) && photosCount > 0) {
	...
	render() {
		...
		return (
			<NavItem eventKey={2} onClick={this.handleSubmit} className={'saveText'}>
