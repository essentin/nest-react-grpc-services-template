...
class WishListModal extends Component {
  ...
  componentDidMount() {
    ...
    let coverImage =
      UserListing &&
      UserListing.listPhotos &&
      UserListing.listPhotos.find((o) => o.id == coverPhoto);
    ...
    if (coverImage) {
      ...
      UserListing &&
      UserListing.listPhotos &&
      UserListing.listPhotos.length > 0
    ) {
      showImage =
        path + (UserListing.listPhotos && UserListing.listPhotos[0].name);
      this.setState({ showImage: showImage });
    }
  }
            ...
            <div className={s.displayTableRow}>
              ...
              >
                <div className={cx(s.footerContainer, s.listDetail)}>
                  <a href={'/space/' + listId} className={s.linkContainer}>
              ...
              <div className={cx(s.displayTableCell, s.contentWidth, s.vtrTop)}>
                <div className={s.sectionBlock}>
                  ...
                  <Modal.Body bsClass={s.logInModalBody}>
                    <div
                      className={cx(s.wishListTitle, s.wishListTitlePadding)}
                    >
                      <span>
