...
//Images
import heartImage from '../../../public/SiteIcons/normal-wishlist.png';
import heartIconFill from '../../../public/SiteIcons/active-wishlist.png';
                      ...
                      <div className={cx(s.checkBoxSection)}>
                        ...
                        }
                        {
                          !loading[option.id] && (option.wishListIds.indexOf(listId) !== -1) && <span onClick={(event) => {
                            ...
                            <img src={heartIconFill} className={s.wishListIcon} alt="heartIconFill" />
                          </span>
                        }
                        {
                          !loading[option.id] && (option.wishListIds.indexOf(listId) == -1) && <span onClick={(event) => {
                            ...
                            <img src={heartImage} className={s.wishListIcon} alt="heartImage" />
                          </span>
                        }
                      </div>
                    </li>
