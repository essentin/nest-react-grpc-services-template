      ...
      <div>
        <Row className={cx(s.pageContent)}>
          <div className={cx(s.space2)}>
                      ...
                      !item.isAdmin && item.authorData && <Col sm={12} className={s.reviewContainer}>
                        ...
                        <div className={s.alignMiddle}>
                          <div className={s.infoAlign}>
                            {/* <div><StarRating value={starRatingValue} /></div> */}
                            <p className={s.textBold}>{item.authorData.firstName}</p>
                            <span>{date}</span>
                          </div>
                        </div>
                      </Col>
                    }
                    {
                      item.isAdmin && <Col sm={12} className={s.reviewContainer}>
                        ...
                        <div className={s.alignMiddle}>
                          <div className={s.infoAlign}>
                            <div><StarRating value={starRatingValue} /></div>
                            <p className={s.textBold}>{formatMessage(messages.verifiedBy) + ' ' + siteName}</p>
                            <span>{date}</span>
                          </div>
                        </div>
                      </Col>
            ...
            {
              showLoadMore && <div className={s.loadBtn}>
                <a className={cx(s.btn, s.btnPrimary, s.btnlarge)} onClick={() => this.loadMore()}>
                  <FormattedMessage {...messages.SeeMoreReviews} />
                </a>
              </div>
            }
          </div>
