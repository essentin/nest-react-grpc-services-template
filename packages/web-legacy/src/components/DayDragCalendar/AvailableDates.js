...
class AvailableDates extends Component {
    ...
    async submitForm() {
        ...
        const { formatMessage } = this.props.intl;
        const { cancellationPolicy, maxDaysNotice, bookingNoticeTime, manageListingSteps, spaceAvailability } = this.props;
        const { currency, isStartDate, isEndDate } = this.props;
