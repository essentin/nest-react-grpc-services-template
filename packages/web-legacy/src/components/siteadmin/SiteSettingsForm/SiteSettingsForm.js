              ...
              <Panel className={s.panelHeader}>
                <form onSubmit={handleSubmit(submit)}>
                  ...
                  <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                    ...
                    <Col xs={12} sm={12} md={12} lg={4} className={s.space2}>
                      ...
                      >
                        ...
                        <option value={3}>Banner Text Layout with Search form</option>
                        {/* <option value={4}>Single Banner Image Layout with Detailed Search form</option> */}
                        <option value={5}>Banner Text Layout with Detailed Search form</option>
                      </Field>
                    </Col>
                    <Col xs={12} sm={12} md={12} lg={4} className={s.space2}>
                      <Field
                  ...
                  <Col xs={12} sm={12} md={12} lg={12} className={s.noPadding}>
                    ...
                    <Col xs={12} sm={12} md={12} lg={6} className={s.space2}>
                      <Field name="phoneNumber" type="text" component={this.renderFormControl} label={"Mobile Number"} maxlength={30} />
                    </Col>
                  </Col>
