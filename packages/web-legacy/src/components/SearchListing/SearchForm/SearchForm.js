...
class SearchForm extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (guests != personalized.personCapacity) {
      setPersonalizedValues({ name: 'personCapacity', value: guests });
    }
  }
  ...
  render() {
    ...
    const { formatMessage } = this.props.intl;
    const { total, location, showResults } = this.props;
    ...
    let maxPriceRange = priceRangeLabel != undefined ? priceRangeLabel[1] : 0;
