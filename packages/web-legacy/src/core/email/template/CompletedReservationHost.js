...
class CompletedReservationHost extends React.Component {
  ...
  render() {
    ...
    const {
      content: { guestName, guestLastName, guestProfilePic, siteSettings },
    } = this.props;
            ...
            <TBody>
              <TR>
                <TD style={textStyle}>
                  ...
                  <EmptySpace height={20} />
                  <div>
                    {guestName} just checked out, so now is the perfect time to
                    write your review.
                  </div>
                  <EmptySpace height={20} />
                  <div>
                    ...
                    feedback - it'll only take few minutes.
                  </div>
