...
class BookingExpiredGuest extends Component {
  ...
  render() {
    ...
    const {
      content: { guestName, listTitle, confirmationCode, checkIn, logo, siteSettings },
    } = this.props;
    let checkInDate =
              ...
              <TR>
                <TD style={textStyle}>
                  ...
                  <div>
                    ...
                    {confirmationCode} starting on {checkInDate} has expired.
                    You will be fully refunded and notified.
                  </div>
