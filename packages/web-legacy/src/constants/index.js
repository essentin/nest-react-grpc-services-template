...
// Forgot password Modal Open and Close actions
...
export const BOOKING_PROCESS_END = 'BOOKING_PROCESS_END';
...
export const BOOKING_PAYMENT_END = 'BOOKING_PAYMENT_END';
...
export const REMOVE_BLOCKED_TIMES_PAYMENT_START =
  'REMOVE_BLOCKED_TIMES_PAYMENT_START';
export const REMOVE_BLOCKED_TIMES_PAYMENT_SUCCESS =
  'REMOVE_BLOCKED_TIMES_PAYMENT_SUCCESS';
export const REMOVE_BLOCKED_TIMES_PAYMENT_ERROR =
...
export const SET_DEFAULT_CARD_ERROR = 'SET_DEFAULT_CARD_ERROR';

// Card - Get Default
export const GET_DEFAULT_CARD_START = 'GET_DEFAULT_CARD_START';
...
export const UPDATE_STATIC_INFO_BLOCK_SUCCESS =
  'UPDATE_STATIC_INFO_BLOCK_SUCCESS';
...
// HOME BOOKING MODAL
export const OPEN_HOME_BOOKING_MODAL = 'OPEN_HOME_BOOKING_MODAL';
export const CLOSE_HOME_BOOKING_MODAL = 'CLOSE_HOME_BOOKING_MODAL';

// Payment BOOKING MODAL
export const OPEN_PAYMENT_BOOKING_MODAL = 'OPEN_PAYMENT_BOOKING_MODAL';
export const CLOSE_PAYMENT_BOOKING_MODAL = 'CLOSE_PAYMENT_BOOKING_MODAL';

// Add Home Card MODAL
export const OPEN_HOME_ADD_CARD_MODAL = 'OPEN_HOME_ADD_CARD_MODAL';
export const CLOSE_HOME_ADD_CARD_MODAL = 'CLOSE_HOME_ADD_CARD_MODAL';

// Add View Card MODAL
export const OPEN_VIEW_LIST_ADD_CARD_MODAL = 'OPEN_VIEW_LIST_ADD_CARD_MODAL';
export const CLOSE_VIEW_LIST_ADD_CARD_MODAL = 'CLOSE_VIEW_LIST_ADD_CARD_MODAL';
...
// Load Activity Type Data
export const ADMIN_LOAD_ACTIVITY_TYPE_START = 'ADMIN_LOAD_ACTIVITY_TYPE_START';
export const ADMIN_LOAD_ACTIVITY_TYPE_SUCCESS =
  'ADMIN_LOAD_ACTIVITY_TYPE_SUCCESS';
export const ADMIN_LOAD_ACTIVITY_TYPE_ERROR = 'ADMIN_LOAD_ACTIVITY_TYPE_ERROR';

export const GET_LISTING_ACTIVITY_START = 'GET_LISTING_ACTIVITY_START';
export const GET_LISTING_ACTIVITY_SUCCESS = 'GET_LISTING_ACTIVITY_SUCCESS';
export const GET_LISTING_ACTIVITY_ERROR = 'GET_LISTING_ACTIVITY_ERROR';
export const GET_LISTING_ACTIVITY_RESET = 'GET_LISTING_ACTIVITY_RESET';

export const GET_SELECTED_ACTIVITY_START = 'GET_SELECTED_ACTIVITY_START';
export const GET_SELECTED_ACTIVITY_SUCCESS = 'GET_SELECTED_ACTIVITY_SUCCESS';
export const GET_SELECTED_ACTIVITY_ERROR = 'GET_SELECTED_ACTIVITY_ERROR';
export const GET_SELECTED_ACTIVITY_RESET = 'GET_SELECTED_ACTIVITY_RESET';

export const SET_ACTIVITY_TYPE_SUCCESS = 'SET_ACTIVITY_TYPE_SUCCESS';
export const SET_ACTIVITY_TYPE_RESET = 'SET_ACTIVITY_TYPE_RESET';

export const SET_FILTER_ACTIVITY_TYPE_SUCCESS =
  'SET_FILTER_ACTIVITY_TYPE_SUCCESS';
export const SET_FILTER_ACTIVITY_TYPE_RESET = 'SET_FILTER_ACTIVITY_TYPE_RESET';

// Icon insert/update to Listing Amenities from admin panel
export const ICON_SETTING_UPLOAD_LOADER_START =
  'ICON_SETTING_UPLOAD_LOADER_START';
export const ICON_SETTING_UPLOAD_START = 'ICON_SETTING_UPLOAD_START';
export const ICON_SETTING_UPLOAD_SUCCESS = 'ICON_SETTING_UPLOAD_SUCCESS';
export const ICON_SETTING_UPLOAD_ERROR = 'ICON_SETTING_UPLOAD_ERROR';

// GET End Times Lookup
export const GET_END_TIME_LOOKUP_START = 'GET_END_TIME_LOOKUP_START';
export const GET_END_TIME_LOOKUP_SUCCESS = 'GET_END_TIME_LOOKUP_SUCCESS';
export const GET_END_TIME_LOOKUP_ERROR = 'GET_END_TIME_LOOKUP_ERROR';

// GET  Times Lookup
export const GET_TIMES_LOOKUP_START = 'GET_TIMES_LOOKUP_START';
export const GET_TIMES_LOOKUP_SUCCESS = 'GET_TIMES_LOOKUP_SUCCESS';
export const GET_TIMES_LOOKUP_ERROR = 'GET_TIMES_LOOKUP_ERROR';

// GET Available Times Lookup
export const GET_AVAILABLE_TIME_LOOKUP_START =
  'GET_AVAILABLE_TIME_LOOKUP_START';
export const GET_AVAILABLE_TIME_LOOKUP_SUCCESS =
  'GET_AVAILABLE_TIME_LOOKUP_SUCCESS';
export const GET_AVAILABLE_TIME_LOOKUP_ERROR =
  'GET_AVAILABLE_TIME_LOOKUP_ERROR';

// GET Why Choose Content
export const GET_WHYCHOOSE_CONTENT_START = 'GET_WHYCHOOSE_CONTENT_START';
export const GET_WHYCHOOSE_CONTENT_SUCCESS = 'GET_WHYCHOOSE_CONTENT_SUCCESS';
export const GET_WHYCHOOSE_CONTENT_ERROR = 'GET_WHYCHOOSE_CONTENT_ERROR';

//GET Mobile Apps Content
export const GET_MOBILEAPPS_CONTENT_START = 'GET_MOBILEAPPS_CONTENT_START';
export const GET_MOBILEAPPS_CONTENT_SUCCESS = 'GET_MOBILEAPPS_CONTENT_SUCCESS';
export const GET_MOBILEAPPS_CONTENT_ERROR = 'GET_MOBILEAPPS_CONTENT_ERROR';

// Upload Cancellation
export const CANCELLATION_UPLOAD_LOADER_START =
  'CANCELLATION_UPLOAD_LOADER_START';
export const CANCELLATION_UPLOAD_START = 'CANCELLATION_UPLOAD_START';
export const CANCELLATION_UPLOAD_SUCCESS = 'CANCELLATION_UPLOAD_SUCCESS';
export const CANCELLATION_UPLOAD_ERROR = 'CANCELLATION_UPLOAD_ERROR';

// Remove Cancellation
export const REMOVE_CANCELLATION_START = 'REMOVE_CANCELLATION_START';
export const REMOVE_CANCELLATION_SUCCESS = 'REMOVE_CANCELLATION_SUCCESS';
export const REMOVE_CANCELLATION_ERROR = 'REMOVE_CANCELLATION_ERROR';

export const OPEN_CANCEL_MODAL = 'OPEN_CANCEL_MODAL';
export const CLOSE_CANCEL_MODAL = 'CLOSE_CANCEL_MODAL';

//Invites
export const CREATE_INVITES_START = 'CREATE_INVITES_START';
export const CREATE_INVITES_SUCCESS = 'CREATE_INVITES_SUCCESS';
export const CREATE_INVITES_ERROR = 'CREATE_INVITES_ERROR';

export const CLOSE_SEND_INVITES_MODAL = 'CLOSE_SEND_INVITES_MODAL';
export const OPEN_SEND_INVITES_MODAL = 'OPEN_SEND_INVITES_MODAL';

export const SET_INITIAL_PERSONALIZED_VALUES = "SET_INITIAL_PERSONALIZED_VALUES";

// View Booking Page - Cancellation Modal
export const OPEN_CANCELLATION_MODAL = 'OPEN_CANCELLATION_MODAL';
export const CLOSE_CANCELLATION_MODAL = 'CLOSE_CANCELLATION_MODAL';


// Get Cancellation Data 
export const GET_CANCELLATION_DATA_START = 'GET_CANCELLATION_DATA_START';
export const GET_CANCELLATION_DATA_SUCCESS = 'GET_CANCELLATION_DATA_SUCCESS';
export const GET_CANCELLATION_DATA_ERROR = 'GET_CANCELLATION_DATA_ERROR';
...
// Manage user
export const OPEN_MANAGE_USER_MODAL = 'OPEN_MANAGE_USER_MODAL';
export const CLOSE_MANAGE_USER_MODAL = 'CLOSE_MANAGE_USER_MODAL';

// Workplace suggest modal
export const OPEN_WORKPLACE_SUGGEST_MODAL = 'OPEN_WORKPLACE_SUGGEST_MODAL';
export const CLOSE_WORKPLACE_SUGGEST_MODAL = 'CLOSE_WORKPLACE_SUGGEST_MODAL';

//Feature flag
export const SET_FEATURE_FLAG = 'SET_FEATURE_FLAG';

// Apply for Beta Modal
export const OPEN_APPLY_FOR_BETA_MODAL = 'OPEN_APPLY_FOR_BETA_MODAL';
export const CLOSE_APPLY_FOR_BETA_MODAL = 'CLOSE_APPLY_FOR_BETA_MODAL';

// Create host Modal
export const OPEN_CREATE_HOST_MODAL = 'OPEN_CREATE_HOST_MODAL';
export const CLOSE_CREATE_HOST_MODAL = 'CLOSE_CREATE_HOST_MODAL';